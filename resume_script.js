...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function buildResume() {
    ...
    var aboutMe = document.getElementById("aboutInput").value;
    ...
    workEntries.forEach(function (entry) {
      ...
      var duration = entry.querySelector('input[name="duration"]').value;
      var responsibilities = entry.querySelector(
    ...
    document.getElementById("user-job-title").innerText = jobTitle;
    ...
    document.getElementById("user-location").innerText = "Location: ".concat(
      location
    );
    ...
    educationSection.innerHTML = educationData
      .map(function (edu) {
        return "<li>"
          .concat(edu.degree, " - ")
          .concat(edu.institution, ", ")
          .concat(edu.duration, "</li>");
      })
      .join("");
    ...
    workExperienceSection.innerHTML = workData
      .map(function (work) {
        return "\n        <h3>"
          .concat(work.jobTitle, " at ")
          .concat(work.company, "</h3>\n        <p>")
          .concat(work.duration, "</p>\n        <ul>")
          .concat(
            work.responsibilities
              .split("\n")
              .map(function (resp) {
                return "<li>".concat(resp, "</li>");
              })
              .join(""),
            "</ul>\n      "
          );
    ...
    skillsSection.innerHTML = "<ul>".concat(
      skills
        .map(function (skill) {
  ...
  (_a = document.getElementById("addEducation")) === null || _a === void 0
    ? void 0
    : _a.addEventListener("click", addEducationEntry);
  (_b = document.getElementById("addWork")) === null || _b === void 0
    ? void 0
    : _b.addEventListener("click", addWorkEntry);
  resumeForm.addEventListener("click", function (event) {
    ...
    if (event.target.classList.contains("remove-work")) {
      (_b = event.target.parentElement) === null || _b === void 0
        ? void 0
        : _b.remove();
    }
  });
